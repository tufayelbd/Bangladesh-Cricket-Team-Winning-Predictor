...
class Root(Tk):
    def __init__(self):
        ...
        self.configure(background="#7B68EE")
                       
        self.img=PhotoImage(file="imoji.png")

        l=Label(image=self.img,background="#7B68EE")
        l.place(x=450,y=100)
    ...
    def Design(self):
        ...
        label=Label(self,text=" Please Give The Information Below  ",bg="#7B68EE",font = ('Arial' , 10))
...
class FindEuclideanDistance:
    def __init__(self,Data):
        ...
        if oponentTeam.empty:
            ...
            labelR.configure(text="Bangladesh May Be Loss This Match",font = ('Arial' , 10))
          
            print(" Bangladesh Win This Match")
        elif optVenueMatch.empty:
            labelR.configure(text=" Bangladesh Has 50% Winnig Chance ! ",font = ('Arial' , 10))
...
class FindList:
    def __init__(self,L,d):
        ...
        global labelR
        if w>l:
            labelR.configure(text=" Bangladesh May Be Win This Match ",font = ('Arial' , 10))
